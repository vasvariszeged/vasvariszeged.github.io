...
A _Visual Studio_ Community Edition letölthető a https://visualstudio.microsoft.com/downloads oldalról. A __Visual Studio 2022__-es vagy újabb verzióját érdemes letölteni ahhoz, hogy összes funkciót használni tudjuk majd. Vegyük figyelembe, hogy ez nem magát a _Visual Studio_-t, hanem a _Visual Studio_ telepítőjét tölti le. A __Visual Studio Installer__ segítségével testre szabhatjuk, hogy mely komponenseket telepítse. Bármikor, amikor módosítani szeretnénk a rendelkezésre álló funkciókat, futtassuk újra a telepítőt, és végezzük el a kívánt módosításokat.
...
Telepíthetünk mindent is, ami érdekesnek tűnik, de most csak egy elemet kell telepítenünk. A __Workloads__ fülön keressük meg azt, amit __.NET desktop development__-nek hívnak, és kattintsunk rá annak engedélyezéséhez. Ha elfelejted ezt megtenni, mindig újra futtathatod a _Visual Studio_ Installer-t, és megváltoztathatod, hogy milyen összetevőket telepítettél.

:::warning Figyelem! Ügyeljenünk arra, hogy a megfelelő Workloads-okat telepítsük. Ha nem így teszel, nem fogod tudni használni az összes C# funkciót.
:::

Miután telepítettük a _Visual Studio_-t, nyissuk meg azt. A _Visual Studio_ meg fogja kérni, hogy jelentkezzünk be egy Microsoft-fiókkal, még az ingyenes _Community Edition_ esetében is. Nem kell bejelentkezned, ha nem akarsz, de lehetővé tesz néhány funkciót - _például a beállítások szinkronizálását több eszközön keresztül_.

Ha először telepíted a _Visual Studio_-t, akkor lehetőséget kapsz a fejlesztési beállítások - _billentyűparancsok és színtéma_ - kiválasztására is. Bármit is választasz, később is megváltoztathatod. Akkor tudjuk, hogy készen vagyunk, amikor elérjük az alábbi indítóképernyőt:
